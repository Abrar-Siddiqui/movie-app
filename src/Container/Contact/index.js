...
const  ContactContainer = ()=>{
    const myData = [
        {name:'GitHub', link:'https://github.com/Abrar-Web-Developer/movie-app', text:'Follow to my github account.'},        
    ]
    return (
            ...
            <Row>
                <Col className='conectIcon'>
                    <ul className='socialIconsList'>
                        ...
                        <li>
                            <a rel="noreferrer" href="https://github.com/Abrar-Web-Developer/movie-app" target="_blank">
                                <BsGithub />
                            </a>
                        </li>
                    </ul>
